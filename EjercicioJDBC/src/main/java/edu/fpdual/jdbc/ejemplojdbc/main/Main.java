                    ...
                    case 1:
                        ...
                        switch (s.nextInt()) {
                            ...
                            case 6:
                                ...
                                int poblacion = 18620;
                                String tabla = "city";
                                new CityAdd().addCiudad(con, id, nombre, pais, ciudad, poblacion);
                                break;
                            case 7:
                                id = 4100;
                                nombre = "campa";
                                new CityModify().editCiudad(con, id, nombre);
                                break;
                            case 8:
                                id = 4100;
                                new CityRemove().delCiudad(con, id);
                                break;
                            case 9:
                                salir = true;
                                break;
                    ...
                    case 2:
                        ...
                        switch (s.nextInt()) {
                            ...
                            case 6:
                                ...
                                String code2 = "QY";
                                new CountryAdd().addPais(con, code, name, continente, region, surfaceArea, indepYear, pop, lifeExpec, gnp, gnpOld, localName, govern, headOfState, capital, code2);
                                break;
                            case 7:
                                code = "NCM";
                                name = "campa";
                                new CountryModify().editPais(con, code, name);
                                break;
                            case 8:
                                code = "NCM";
                                new CountryRemove().delPais(con, code);
                                break;
                            case 9:
                                salir = true;
                                break;
